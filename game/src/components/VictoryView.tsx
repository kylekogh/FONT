...
import styles from './VictoryView.module.css';
...
export default function VictoryView({ run, dispatch }: Props) {
  return (
    <div className={styles.root}>
      <div className={styles.headline}>The rival falls.</div>
      <p className={styles.sub}>The path continues. It always does.</p>
